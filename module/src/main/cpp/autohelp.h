...
monoString *CreateMonoStringType(const char *str) {
    monoString *(*String_CreateString)(void *instance, const char *str) = (monoString *(*)(void *, const char *))getAdresss(mono_address);
    return String_CreateString(NULL, str);
}

monoString *il2cpp_string_new(const char *str) {
    monoString *(*String_CreateString)(void *instance, const char *str, int start, int len) = (monoString *(*)(void *, const char *, int, int)) getAbsoluteAddress("lib/arm/libil2cpp.so", 0x27C3274);
